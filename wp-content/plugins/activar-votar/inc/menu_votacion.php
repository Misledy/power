...
function votar_create_admin_menu() { 
 add_menu_page ( 'Activar Votaciones', 'Activar Votaciones', 'manage_options', 'votar_create_admin_menu_plugin', 'activar_pagina_de_opciones', 'dashicons-email' );

}

function activar_pagina_de_opciones(){

    echo("<div class='wrap'><h3>Shortcode</h3></div>"); 
    echo("<div class='wrap'><p>[activar_votar]  /**General **/</p></div>");
    echo("<div class='wrap'><p>do_shortcode('[activar_votar]') /**Para colocar dentro del tema**/</p></div>");
